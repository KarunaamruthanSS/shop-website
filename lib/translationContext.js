...
const translations = {
  en: {
    // Navigation
    'Sathya Hardwares': 'Sathya Hardwares',
    ...
    'Why hardwares are important?': 'Why hardwares are important?',
    'Hardware products play a vital role in construction, maintenance, and everyday repairs in homes and businesses. Quality hardware items such as electrical fittings, tools, fasteners, and plumbing materials ensure safety and long-lasting performance. Reliable hardware is essential for building strong infrastructure and maintaining modern living standards. Hardware stores provide essential materials that support residential, commercial, and industrial development. Using the right hardware helps reduce repair costs and improves energy efficiency. Professionals and homeowners rely on hardware products for installation, upgrades, and maintenance work. Proper hardware selection prevents accidents and improves overall system reliability. Modern hardware solutions support smart technology and sustainable construction practices. Hardware products contribute significantly to economic growth and job creation. Without dependable hardware, daily operations in construction, electrical, and mechanical fields would not be possible.': 'Hardware products play a vital role in construction, maintenance, and everyday repairs in homes and businesses. Quality hardware items such as electrical fittings, tools, fasteners, and plumbing materials ensure safety and long-lasting performance. Reliable hardware is essential for building strong infrastructure and maintaining modern living standards. Hardware stores provide essential materials that support residential, commercial, and industrial development. Using the right hardware helps reduce repair costs and improves energy efficiency. Professionals and homeowners rely on hardware products for installation, upgrades, and maintenance work. Proper hardware selection prevents accidents and improves overall system reliability. Modern hardware solutions support smart technology and sustainable construction practices. Hardware products contribute significantly to economic growth and job creation. Without dependable hardware, daily operations in construction, electrical, and mechanical fields would not be possible.',

    // FAQ Section
    'Frequently Asked Questions': 'Frequently Asked Questions',
    'What are hardware products used for?': 'What are hardware products used for?',
    'Hardware products are used for construction, electrical work, plumbing, repairs, and maintenance in homes, offices, and industrial buildings.': 'Hardware products are used for construction, electrical work, plumbing, repairs, and maintenance in homes, offices, and industrial buildings.',
    'Why is quality hardware important?': 'Why is quality hardware important?',
    'Quality hardware ensures safety, durability, and long-term performance, reducing the need for frequent repairs and replacements.': 'Quality hardware ensures safety, durability, and long-term performance, reducing the need for frequent repairs and replacements.',
    'How do I choose the right hardware products?': 'How do I choose the right hardware products?',
    'Choosing the right hardware depends on the type of work, material quality, compatibility, and safety standards required for the project.': 'Choosing the right hardware depends on the type of work, material quality, compatibility, and safety standards required for the project.',
    'Can hardware products improve safety in buildings?': 'Can hardware products improve safety in buildings?',
    'Yes, using proper and certified hardware products helps prevent electrical faults, structural failures, and other safety risks.': 'Yes, using proper and certified hardware products helps prevent electrical faults, structural failures, and other safety risks.',
    'Are hardware products necessary for everyday home maintenance?': 'Are hardware products necessary for everyday home maintenance?',
    'Hardware products are essential for daily maintenance tasks such as fixing electrical fittings, plumbing issues, and household installations.': 'Hardware products are essential for daily maintenance tasks such as fixing electrical fittings, plumbing issues, and household installations.',
  ...
  ta: {
    // Navigation
    'Sathya Hardwares': 'சத்யா ஹார்ட்வேர்ஸ்',
    ...
    'Why hardwares are important?': 'வன்பொருள்கள் ஏன் முக்கியம்?',
    'Hardware products play a vital role in construction, maintenance, and everyday repairs in homes and businesses. Quality hardware items such as electrical fittings, tools, fasteners, and plumbing materials ensure safety and long-lasting performance. Reliable hardware is essential for building strong infrastructure and maintaining modern living standards. Hardware stores provide essential materials that support residential, commercial, and industrial development. Using the right hardware helps reduce repair costs and improves energy efficiency. Professionals and homeowners rely on hardware products for installation, upgrades, and maintenance work. Proper hardware selection prevents accidents and improves overall system reliability. Modern hardware solutions support smart technology and sustainable construction practices. Hardware products contribute significantly to economic growth and job creation. Without dependable hardware, daily operations in construction, electrical, and mechanical fields would not be possible.': 'வன்பொருள் பொருட்கள் வீடுகள் மற்றும் வணிகங்களில் கட்டுமானம், பராமரிப்பு மற்றும் அன்றாட பழுதுபார்ப்புகளில் முக்கிய பங்கு வகிக்கின்றன. மின்சார பொருத்துதல்கள், கருவிகள், இணைப்பு பொருட்கள் மற்றும் குழாய் பொருட்கள் போன்ற தரமான வன்பொருள் பொருட்கள் பாதுகாப்பு மற்றும் நீண்ட கால செயல்திறனை உறுதி செய்கின்றன. வலுவான உள்கட்டமைப்பை உருவாக்குவதற்கும் நவீன வாழ்க்கை தரத்தை பராமரிப்பதற்கும் நம்பகமான வன்பொருள் அவசியம. வன்பொருள் கடைகள் குடியிருப்பு, வணிக மற்றும் தொழில்துறை வளர்ச்சியை ஆதரிக்கும் அத்தியாவசிய பொருட்களை வழங்குகின்றன. சரியான வன்பொருளைப் பயன்படுத்துவது பழுதுபார்ப்பு செலவுகளைக் குறைக்கவும் ஆற்றல் திறனை மேம்படுத்தவும் உதவுகிறது. நிபுணர்கள் மற்றும் வீட்டு உரிமையாளர்கள் நிறுவல், மேம்படுத்தல் மற்றும் பராமரிப்பு வேலைகளுக்கு வன்பொருள் பொருட்களை நம்பியுள்ளனர். சரியான வன்பொருள் தேர்வு விபத்துகளைத் தடுக்கிறது மற்றும் ஒட்டுமொத்த அமைப்பு நம்பகத்தன்மையை மேம்படுத்துகிறது. நவீன வன்பொருள் தீர்வுகள் ஸ்மார்ட் தொழில்நுட்பம் மற்றும் நிலையான கட்டுமான நடைமுறைகளை ஆதரிக்கின்றன. வன்பொருள் பொருட்கள் பொருளாதார வளர்ச்சி மற்றும் வேலை உருவாக்கத்தில் குறிப்பிடத்தக்க பங்களிப்பை வழங்குகின்றன. நம்பகமான வன்பொருள் இல்லாமல், கட்டுமானம், மின்சாரம் மற்றும் இயந்திர துறைகளில் தினசரி செயல்பாடுகள் சாத்தியமில்லை.',
    'View All Products': 'அனைத்து பொருட்களையும் பார்க்கவும்',

    // FAQ Section
    'Frequently Asked Questions': 'அடிக்கடி கேட்கப்படும் கேள்விகள்',
    'What are hardware products used for?': 'வன்பொருள் பொருட்கள் எதற்காக பயன்படுத்தப்படுகின்றன?',
    'Hardware products are used for construction, electrical work, plumbing, repairs, and maintenance in homes, offices, and industrial buildings.': 'வன்பொருள் பொருட்கள் வீடுகள், அலுவலகங்கள் மற்றும் தொழில்துறை கட்டிடங்களில் கட்டுமானம், மின்சார வேலை, குழாய் வேலை, பழுதுபார்ப்பு மற்றும் பராமரிப்புக்காக பயன்படுத்தப்படுகின்றன.',
    'Why is quality hardware important?': 'தரமான வன்பொருள் ஏன் முக்கியம்?',
    'Quality hardware ensures safety, durability, and long-term performance, reducing the need for frequent repairs and replacements.': 'தரமான வன்பொருள் பாதுகாப்பு, நீடித்த தன்மை மற்றும் நீண்ட கால செயல்திறனை உறுதி செய்கிறது, அடிக்கடி பழுதுபார்ப்பு மற்றும் மாற்றுகளின் தேவையை குறைக்கிறது.',
    'How do I choose the right hardware products?': 'சரியான வன்பொருள் பொருட்களை எவ்வாறு தேர்வு செய்வது?',
    'Choosing the right hardware depends on the type of work, material quality, compatibility, and safety standards required for the project.': 'சரியான வன்பொருளைத் தேர்ந்தெடுப்பது வேலையின் வகை, பொருள் தரம், இணக்கத்தன்மை மற்றும் திட்டத்திற்கு தேவையான பாதுகாப்பு தரங்களைப் பொறுத்தது.',
    'Can hardware products improve safety in buildings?': 'வன்பொருள் பொருட்கள் கட்டிடங்களில் பாதுகாப்பை மேம்படுத்த முடியுமா?',
    'Yes, using proper and certified hardware products helps prevent electrical faults, structural failures, and other safety risks.': 'ஆம், சரியான மற்றும் சான்றிதழ் பெற்ற வன்பொருள் பொருட்களைப் பயன்படுத்துவது மின்சார கோளாறுகள், கட்டமைப்பு தோல்விகள் மற்றும் பிற பாதுகாப்பு அபாயங்களைத் தடுக்க உதவுகிறது.',
    'Are hardware products necessary for everyday home maintenance?': 'அன்றாட வீட்டு பராமரிப்புக்கு வன்பொருள் பொருட்கள் அவசியமா?',
    'Hardware products are essential for daily maintenance tasks such as fixing electrical fittings, plumbing issues, and household installations.': 'மின்சார பொருத்துதல்கள், குழாய் பிரச்சினைகள் மற்றும் வீட்டு நிறுவல்கள் போன்ற தினசரி பராமரிப்பு பணிகளுக்கு வன்பொருள் பொருட்கள் அவசியம்.',
    'View All Products': 'அனைத்து பொருட்களையும் பார்க்கவும்',
    ...
    'Please login to add items to cart': 'வண்டியில் பொருட்களை சேர்க்க உள்நுழையவும்',
